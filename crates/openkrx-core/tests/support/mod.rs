//! Test-only synthetic ZIP writer.
//!
//! Every archive used by the archive tests is generated here, in this
//! repository, from scratch. No third-party or real package is involved, and
//! nothing is committed as a binary fixture. The writer deliberately allows
//! contradictory headers so hostile archives can be constructed exactly.
